...
//    println(page)
    ...
    // https://duckduckgo.com/i.js?l=us-en&o=json&q=party&vqd=4-291889018474034180316943829944409826880&f=,,,,,&p=1
    val baseUrl = "https://duckduckgo.com/i.js?l=us-en&o=json&q=$safeQuery&vqd=$vqd&f=,,,,,&p=1"
